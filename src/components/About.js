            ...
            <div className='about_section shelf space_around expand_80 wrap mt_100'>
                ...
                <div className='expand_50 left margin_16'>
                    ...
                    <ul className='mt_16 mb_50 ml_16 '>
                        <li className='font_13 light t_black margin_8'><FiCheck className='t_purple' /> Canada</li>
                        <li className='font_13 light t_black margin_8'><FiCheck className='t_purple' /> Unites States</li>
                        <li className='font_13 light t_black margin_8'><FiCheck className='t_purple' /> & Many more...</li>
                    </ul>
